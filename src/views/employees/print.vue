  ...
  <div class="dashboard-container">
    <div class="app-container">
      <el-row type="flex" justify="end">
        <el-button type="primary" v-print="{ id: 'myPrint' }"
          >打印</el-button
        ></el-row
      >
      <el-card id="myPrint">
...
export default {
  ...
  created () {
    // this.getJobInfo()
    this.type === 'userInfo' ? this.getUserInfo() : this.getJobInfo()
  },
  // 组件更新
  methods: {
    async getJobInfo () {
    ...
    async getUserInfo () {
      const res1 = await getUserInfo(this.id)
      const res2 = await employeesPersonalInfo(this.id)
      this.formData = { ...res1, ...res2 }
    }
  }
}
</script>
